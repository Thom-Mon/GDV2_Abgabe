...
{
    CreateVertexShader("..\\data\\shader\\sierpinski.fx", "VSMain", &m_pVertexShader);
    CreatePixelShader("..\\data\\shader\\sierpinski.fx", "PSMain", &m_pPixelShader);
...
bool CApplication::InternOnResize(int _Width, int _Height)
{
    ...
    GetProjectionMatrix(47.0f, AspectRatio, 0.01f, 1000.0f, m_ProjectionMatrix);
...
bool CApplication::InternOnFrame()
{
    ...
    switch (m_MaxIteration%8)
    {
    case 0:
        PerObjectConstantsPS.m_PSColor[0] = 0.25f; //R
        PerObjectConstantsPS.m_PSColor[1] = 0.25f; //G
        PerObjectConstantsPS.m_PSColor[2] = 0.05f;   //B
        break;    
    case 1:
        PerObjectConstantsPS.m_PSColor[0] = 0.25f; //R
        PerObjectConstantsPS.m_PSColor[1] = 0.25f; //G
        PerObjectConstantsPS.m_PSColor[2] = 0.10f;   //B
        break;    
    case 2:
        PerObjectConstantsPS.m_PSColor[0] = 0.25f; //R
        PerObjectConstantsPS.m_PSColor[1] = 0.25f; //G
    ...
    case 3:
        PerObjectConstantsPS.m_PSColor[0] = 0.25f; //R
        PerObjectConstantsPS.m_PSColor[1] = 0.25f; //G
        PerObjectConstantsPS.m_PSColor[2] = 0.20f;   //B
        break;
    case 4:
        PerObjectConstantsPS.m_PSColor[0] = 0.25f; //R
        PerObjectConstantsPS.m_PSColor[1] = 0.25f; //G
        PerObjectConstantsPS.m_PSColor[2] = 0.25f;  //B
        break;
    case 5:
        PerObjectConstantsPS.m_PSColor[0] = 0.25f; //R
        PerObjectConstantsPS.m_PSColor[1] = 0.25f; //G
        PerObjectConstantsPS.m_PSColor[2] = 0.30f;   //B
        break;
    case 6:
        PerObjectConstantsPS.m_PSColor[0] = 0.25f; //R
        PerObjectConstantsPS.m_PSColor[1] = 0.25f; //G
        PerObjectConstantsPS.m_PSColor[2] = 0.35f;   //B
        break;
    case 7:
        PerObjectConstantsPS.m_PSColor[0] = 0.25f; //R
        PerObjectConstantsPS.m_PSColor[1] = 0.25f; //G
        PerObjectConstantsPS.m_PSColor[2] = 0.40f;   //B
        break;
    default:
